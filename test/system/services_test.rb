...
class ServicesTest < ApplicationSystemTestCase
  ...
  test "creating a Service" do
    ...
    fill_in "Connection phrase", with: @service.connection_phrase
    fill_in "Created by", with: @service.created_by
    fill_in "Description", with: @service.description
    fill_in "Name", with: @service.name
    fill_in "Update count", with: @service.update_count
    fill_in "Updated by", with: @service.updated_by
